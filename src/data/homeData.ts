...
export const services = [
  ...
  },
  {
    ...
    description:
      "Smart device integration using microcontroller-based systems.",
  },
  {
    icon: ImageIcon,
    title: "Electronic & PCB Design",
    description:
      "Custom circuit design, PCB layout, and fabrication solutions.",
  },
];
...
export const journeyMilestones = [
  ...
  },
  {
    ...
    description:
      "Delivered initial web and electronic system projects for local clients.",
  },
  {
    year: "2020",
    note: "SYS LOG 2020\nSTABLE REL.",
  ...
  },
  {
    ...
    description:
      "Developed custom platforms, dashboards, and mobile applications.",
  },
  {
    year: "Future",
    title: "Looking Ahead",
    description:
      "Continuously innovating in software, electronics, and smart systems.",
  },
];
